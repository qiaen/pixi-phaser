...
function init() {
	...
	let targetRotationOnPointerYDown = 0
	let pointerX = 0
	...
	function onPointerDown(event) {
		...
		targetRotationOnPointerYDown = targetRotationY
		// console.log('last angle=', Y)
	...
	function onPointerMove(event) {
		...
		targetRotationY = targetRotationOnPointerYDown + (pointerY - pointerYOnPointerDown) * 0.02
		// console.log('this angle=', targetRotation)
	}
	...
	function animate() {
		...
		// console.log('benci', group.rotation.y)
		// 把这一行一动到了上面，cameraTarget没有一直改变，所以好像也没问题
		// camera.lookAt(cameraTarget)
